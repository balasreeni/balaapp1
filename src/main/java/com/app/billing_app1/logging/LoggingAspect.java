package com.app.billing_app1.logging;
...
public class LoggingAspect {
	...
	@Pointcut("execution(* com.app.billing_app1.controller.*.*(..)) || execution(* com.app.billing_app1.services.*.*(..)) || execution(* com.app.billing_app1.dao.*.*(..))")
	private void selectAll() {
	}

	@AfterReturning(pointcut = "execution(* com.app.billing_app1.controller.*.*(..))", returning = "retVal")
	...
	@Pointcut("execution(* com.app.billing_app1.controller.*.*(..))")
